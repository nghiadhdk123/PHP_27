...
<html lang="en">
    ...
    <body>
        <?php 
            if(isset($_COOKIE['sussecc_add']))
            {
         ?>
         <div class="alert alert-success">
             <strong><?php echo $_COOKIE['sussecc_add'] ?></strong>
        </div>
        <?php } ?>

        <?php 
            if(isset($_COOKIE['error_add']))
            {
         ?>
         <div class="alert alert-success">
             <strong><?php echo $_COOKIE['error_add'] ?></strong>
        </div>
        <?php } ?>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="index.php?admin=admin&mod=post&act=list_dete">Xóa hoặc Sửa bài viết</a>
                ...
                <main style="padding: 0% 10%;">
                        ...
                        <table class="table">
                            <form action="index.php?admin=admin&mod=post&act=create" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="hidden" class="form-control" id="" placeholder="" name="user_id" value="<?= $_SESSION['auth']['user_id']?>" >
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="categories_id" id=""  class="form-control">
                                        ...
                                        ?>
                                            <option value="<?=$value['categories_id']?>" class="form-control">
                                                <?= $value['name1'] ?>
                                            </option>
                                        <?php } ?>
                                    </select>
