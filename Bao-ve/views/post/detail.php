   ...
   <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
      <div class="site-wrap">
         ...
         <div class="container-fluid" style="margin-top: 10%;">
            <div class="container">
               <h1 style="color: black">
                  <?php echo $detailPost['title'] ?>
               </h1>
               <div class="content" style="width: 100% ; margin: auto;">
                  <img src=" <?= $detailPost['thumbnail'] ?> " alt="" width='100%' height='auto'>
                  <h4 style="margin-top: 3%;color: black">
                     <?= $detailPost['description'] ?>
                  </h4>
                  <p style="margin-top: 3%;font-size: 20px">
                     <?= $detailPost['content'] ?>
                  </p>
               </div>
            </div>
         ...
         <div class="container-fluid">
            <div class="container" style="border-top: 2px solid black;padding-top: 2%;box-sizing: border-box;">
               <h2 style="margin-bottom: 3%">Bạn có thể quan tâm</h2>
               <div class="row">
                  <?php foreach ($nhieuPosts as $key => $value) {
